...
const float TROLLEY_START_POSITION_X = 0.78; //might have to change
const float TROLLEY_START_POSITION_Y = 4.65; //might have to change
byte trolley_coordinate_X = 5; //might have to change
byte trolley_coordinate_Y = 7; //might have to change
char mov [4] = {0, 0, 0, 0};
...
const byte SQUARE_SIZE = 195;  //might have to change
